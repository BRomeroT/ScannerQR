...
/// <summary>
/// MacCatalyst implementation of <see cref="QRScannerView"/> using AVFoundation preview, metadata detection, and zoom.
/// </summary>
public partial class QRScannerHandler : ViewHandler<QRScannerView, UIView>
{
    ...
    /// <summary>
    /// Creates the native MacCatalyst preview surface.
    /// </summary>
    ...
    /// </summary>
    /// <param name="platformView">The native MacCatalyst view.</param>
    ...
    /// <summary>
    /// Disconnects the handler and releases MacCatalyst camera resources.
    /// </summary>
    /// <param name="platformView">The native MacCatalyst view.</param>
    ...
    /// <summary>
    /// Starts the MacCatalyst camera if it is not already running.
    /// </summary>
    ...
    /// <summary>
    /// Stops the MacCatalyst camera pipeline.
    /// </summary>
    ...
    /// <summary>
    /// Applies zoom to the active MacCatalyst capture device.
    /// </summary>
